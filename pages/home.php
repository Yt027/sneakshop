...
<body>
    ...
    <main class="page">
        ...
        <section class="hero">
            ...
            <img src="<?=APP_URL?>assets/images/Shoes-White.H03.2k.png" alt="" class="hero-img">
        </section>
        <!-- Hero Section End -->
        ...
        <section class="fashion">
            ...
            <div class="wrapper product-container">
                <div class="product-card">
                    <img src="<?=APP_URL?>assets/images/Shoes-White.H03.2k.png" alt="" loading="lazy">
                    <div class="content">
                        <div class="top">
                ...
                <div class="product-card">
                    <img src="<?=APP_URL?>assets/images/Male-Sneakers.H03.2k.png" alt="" loading="lazy">
                    <div class="content">
                        <div class="top">
                ...
                <div class="product-card">
                    <img src="<?=APP_URL?>assets/images/Leather-Sports-Sneakers.H03.2k.png" alt="" loading="lazy">
                    <div class="content">
                        <div class="top">
                            <h3 class="name">Nike Air Max 270 React</h3>
                            <span class="price">75 000 FCFA</span>
